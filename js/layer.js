...
$.extend({
    ...
    layer:function (data) {
        ...
        //弹框显示层
        var layer=$('<div style="overflow: hidden; position: fixed; top: 50%; left: 50%; box-sizing: border-box; padding: 0px; margin: -176px 0px 0px -348px; z-index: 101;"> <div style="min-width: 300px;min-height: 300px;background-color: white;float: left;position: relative;padding: 72px 25px 26px 25px;box-sizing: border-box;"></div> <a href="javascript:void(0);" style="background: url(../images/closeWhite.png) no-repeat 50% red;display: block;float: left;width: 25px;overflow: hidden;height: 43px;box-sizing: border-box;"></a> </div>');
    ...
    layer_two: function (data) {
        ...
        //弹框显示层
        var layer = $('<div style="overflow: hidden; position: fixed; top: 50%; left: 50%; box-sizing: border-box; padding: 0px; margin: -176px 0px 0px -348px; z-index: 118;"> <div style="min-width: 300px;min-height: 300px;background-color: white;float: left;position: relative;padding: 72px 25px 26px 25px;box-sizing: border-box;"></div> <a href="javascript:void(0);" style="background: url(../images/closeWhite.png) no-repeat 50% red;display: block;float: left;width: 25px;overflow: hidden;height: 43px;box-sizing: border-box;"></a> </div>');
        var markTwo = $('<div style="overflow: hidden; position: fixed; top: 0; left: 0; display: block; padding: 0; box-sizing: border-box; margin: 0; bottom: 0; background-color: black; z-index: 115; opacity: 0.5; right: 0;"></div>');
    ...
    fromLayer:function(data){
        ...
        //默认居中
        var layer = $('<div style="overflow: hidden; position: fixed; top: 50%; left: 50%; box-sizing: border-box; padding: 0px; margin: -176px 0px 0px -348px; z-index: 106;"> <div style="min-width: 300px;background-color: white;float: left;position: relative;padding: 72px 25px 26px 25px;box-sizing: border-box;"></div> <a href="javascript:void(0);" style="background: url(../images/closeWhite.png) no-repeat 50% red;display: block;float: left;width: 25px;overflow: hidden;height: 43px;box-sizing: border-box;"></a> </div>');
        var layerHead = $('<span style="position: absolute;top: 25px;display: block;width: 94%;left: 3%;height: 40px;box-sizing: border-box;border-bottom: 1px solid #c3c1c1;font-size: 18px; ">' + obj.title + '</span>');
